...
describe BulkDonationRequestImport do
  ...
  before do
    CSV.open(file.path, 'w') do |csv|
      ...
      csv << ["Acrosports", nil, "info@acrosports.org", nil, nil, nil, nil, "Acro fun night $50 value"]
      csv << ["Abada Capoeira", "Tamara McDonald - office manager", "info@abada.org", nil, nil, nil, nil, "Two sets of 4 classes"]
    end
    file.rewind
